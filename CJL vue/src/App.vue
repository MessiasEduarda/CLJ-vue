<template>
  <div id="app">
    ...
    <header :class="['navbar', { scrolled: isScrolled }]">
      ...
      <div class="menu-e-botoes">
        ...
        <div class="navbar-buttons">
          <button class="btn btn-outline">Fale Conosco</button>
    ...
    <div class="pixel-image-container" ref="pixelImageContainer">
      <div
        class="pixel-image"
...
<div class="container">
  <div class="overlay-transparent">
    <div class="titulo-centralizado">
      ...
      <h1>Consultoria CJL</h1>
      <hr class="linha-horizontal" />
      <div class="slide-textos" :key="textoAtual">
        <p>{{ textos[textoAtual] }}</p>
      </div>
      <div
        class="seta-baixo"
        role="button"
...
<!-- Container preto abaixo da imagem -->
<div class="container-preto"></div>
<!-- Nova seção com fundo branco abaixo -->
<section class="nova-secao-branca">
  <div class="conteudo-novo">
    <h2>Sobre a CJL</h2>
    <p>Empresa com crescimento nacional nos últimos 5 anos inovando tecnologias, conformidade e segurança ao seu negócio. Sabemos da importância da sua empresa e por isso nos adaptamos ao modelo empresarial e a qualquer regra de negócio.</p>
  </div>
</section>
...
// Controle da navbar transparente / opaca
...
.nova-secao-branca .conteudo-novo {
  max-width: 1200px; /* limite para o conteúdo */
